...
namespace GameplayAssets.Menu
{
    public class SignInController : MonoBehaviour
    {
        ...
        {
            if (CheckUserNameValidation(inputField.text)) profileUserNameText.text = inputField.text;
            else inputField.text = profileUserNameText.text;
        } 
